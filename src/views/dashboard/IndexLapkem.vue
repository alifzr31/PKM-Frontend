<template>
    <div>
        ...
        <header>
            ...
            <h1 class="display-4 fw-normal">Data Laporan Kemajuan Anda</h1><br/>
            <p class="fs-5 text-muted">
                <router-link :to="{ name: 'lapkem.create' }" class="btn btn-lg btn-primary">Input Laporan <i class="bi bi-arrow-right-circle"></i> </router-link>
            </p>
            </div>
        </header>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <tr v-for="(lapkem, index) in lapkems" :key="index">
                        ...
                        <td>{{ moment(String(lapkem.created_at)).format('dddd-MM-YYYY') }}</td>
                        <td>{{ lapkem.status }}</td>
                        <td><router-link :to="{ name: 'lapkem.detail', params: {id: lapkem.id} }" class="btn btn-sm btn-primary">Lihat Data</router-link></td>
                    </tr>
                </tbody>
            </table>
