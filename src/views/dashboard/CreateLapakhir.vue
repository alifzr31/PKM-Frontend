            ...
            <header>
                ...
                <div>
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Input Laporan Akhir</li>
                    </ol>
                    </nav>
                    </div>
                </div>
                ...
                <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
                    <h1 class="display-4 fw-normal">Input Laporan Akhir</h1>
                </div>
            </header>
            ...
            <main>
                ...
                <div class="col-md-7 col-lg-12">
                    ...
                    <div class="row g-3">
                        ...
                        <input type="text" v-model="lapakhirs.nip" readonly hidden>
                        ...
                        <div class="col-6">
                            <label for="address2" class="form-label">File Laporan Akhir<i><span style="color: red;"> *.pdf | Max 10 Mb</span></i></label>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control" v-model="lapakhirs.catatan" placeholder="Catatan" style="height: 200px; resize: none;"></textarea>
                    ...
                    <button class="w-100 btn btn-primary btn-lg" type="submit">Input Laporan</button>
                    </form>
                </div>
                </div>
            </main>
...
export default {
    setup() {
        ...
        function store() {
            ...
            axios.post('http://localhost:8000/api/lapakhirs', formData)
            .then(response => {
