        ...
        <div class="container py-3">
            <header>
                ...
                <div>
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><router-link :to="{ name: 'dashboard' }" class="text-decoration-none">Proposal</router-link></li>
                        <li class="breadcrumb-item active" aria-current="page">{{ proposals.judul }}</li>
                    </ol>
                    </nav>
                    </div>
                </div>
                ...
                <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
                    <h1 class="display-4 fw-normal">{{ proposals.judul }}</h1>
                </div>
            </header>
            ...
            <main>
                <div class="col">
                    ...
                    <div class="card-header py-3 text-white bg-primary border-primary">
                        <h4 class="my-0 fw-normal">File Proposal</h4>
                    </div>
                    <div class="card-body">
                        <h1 class="card-title pricing-card-title"><small class="text-muted fw-light">{{ proposals.fl_proposal }}</small></h1>
                        <br/>
                        <a :href="`http://localhost:8000/storage/proposals/${proposals.fl_proposal}`" class="w-100 btn btn-lg btn-primary">Download File</a>
                    </div>
                    </div>
                </div>
                ...
                <!-- <div class="col">
                    <div class="card mb-4 rounded-3 shadow-sm border-primary">
                    <div class="card-header py-3 text-white bg-primary border-primary">
                        <h4 class="my-0 fw-normal">File Proposal External</h4>
                    </div>
                    <div class="card-body">
                        <h1 class="card-title pricing-card-title"><small class="text-muted fw-light">{{ proposals.fl_proposal_external }}</small></h1>
                        <br/>
                        <a :href="`http://localhost:8000/storage/proposals/external/${proposals.fl_proposal_external}`" class="w-100 btn btn-lg btn-primary">Download File</a>
                    </div>
                    </div>
                </div> -->
                ...
                <div class="my-3 p-3 bg-light rounded shadow-sm">
                    ...
                    <p class="pb-3 mb-0 small lh-sm border-bottom">
                        <strong class="d-block text-gray-dark">Dana</strong>
                        Rp {{ formatdana(proposals.dana) }}
                    </p>
                    </div>
                    <div class="d-flex text-muted pt-3">
                    <!-- <svg class="bd-placeholder-img flex-shrink-0 me-2 rounded" width="32" height="32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 32x32" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#e83e8c"/><text x="50%" y="50%" fill="#e83e8c" dy=".3em">32x32</text></svg> -->
                    ...
                    <p class="pb-3 mb-0 small lh-sm border-bottom">
                        <strong class="d-block text-gray-dark">Created at</strong>
                        {{ moment(String(proposals.created_at)).format('dddd-MM-YYYY') }}
                    </p>
                    </div>
                    <!-- <small class="d-block text-end mt-3">
                    <router-link :to="{ name: 'proposal.edit' }" class="btn btn-success" style="width: 100%;">Edit Data</router-link>
                    </small> -->
                    <template v-if="proposals.status == 'Revisi'">
                        <router-link :to="{ name: 'proposal.edit' }" class="btn btn-success" style="width: 100%;">Revisi</router-link>
                        <hr/>
                        <p class="pb-3 mb-0 small lh-sm border-bottom">
                            <strong class="d-block text-gray-dark">Catatan Revisi</strong>
                            {{ proposals.catatan_revisi }}
                        </p>
                    </template>
                    <template v-else-if="proposals.status == 'Sedang diproses'">
                        <router-link :to="{ name: 'proposal.edit' }" class="btn btn-success" style="width: 100%;">Edit Data</router-link>
                    </template>
                    <template v-else>
                    </template>
