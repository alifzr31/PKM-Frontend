<template>
    <div >
        ...
        <header>
            <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
                ...
                <div class="dropdown text-end">
                    ...
                    <ul class="dropdown-menu text-small" aria-labelledby="dropdownUser1">
                        ...
                        <li><hr class="dropdown-divider"></li>
                        <!-- <li><router-link class="dropdown-item">Profil Saya</router-link></li> -->
            ...
            <h1 class="display-4 fw-normal">Data Proposal Ajuan Anda</h1><br/>
        ...
        <main>
            ...
            <div class="col" v-for="(prop, index) in proposals" :key="index">
                <div class="card mb-4 rounded-3 shadow-sm">
                <div class="card-header py-3">
                    <h4 class="my-0 fw-normal">{{ prop.judul }}</h4>
                </div>
                <div class="card-body">
                    <h1 class="card-title pricing-card-title">{{ prop.status }}</h1>
                    <ul class="list-unstyled mt-3 mb-4">
                    <li>{{ prop.no_surat }}</li>
                    <li>{{ prop.dana }}</li>
                    </ul>
                    <router-link :to="{ name: 'proposal.detail', params: {id: prop.id} }" class="w-100 btn btn-lg btn-primary">Lihat Data</router-link>
                </div>
                </div>
            </div>

            <div class="col" v-for="(us, index) in user" :key="index">
                <div class="card mb-4 rounded-3 shadow-sm">
                <div class="card-header py-3">
                    <h4 class="my-0 fw-normal">{{ us.name }}</h4>
                </div>
                <div class="card-body">
                    <h1 class="card-title pricing-card-title">{{ us.email }}</h1>
                    <ul class="list-unstyled mt-3 mb-4">
                    <!-- <li>{{ prop.no_surat }}</li> -->
                    <!-- <li>{{ prop.dana }}</li> -->
                    </ul>
