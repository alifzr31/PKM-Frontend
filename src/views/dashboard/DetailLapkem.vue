    ...
    <div>
        ...
        <header>
            <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
                ...
                <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><router-link :to="{ name: 'lapkem.index'}" class="dropdown-item"><b style="color: #0d6efd;">Laporan Kemajuan</b></router-link></li>
            ...
            <div>
                ...
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><router-link :to="{ name: 'lapkem.index' }" class="text-decoration-none">Laporan Kemajuan</router-link></li>
                    <li class="breadcrumb-item active" aria-current="page">{{ lapkems.judul }}</li>
                </ol>
                </nav>
                </div>
            </div>
            ...
            <h1 class="display-4 fw-normal">{{ lapkems.judul }}</h1>
            </div>
        </header>
        ...
        <main>
            <div class="col">
                ...
                <div class="card-header py-3 text-white bg-primary border-primary">
                    <h4 class="my-0 fw-normal">File Laporan Kemajuan</h4>
                </div>
                <div class="card-body">
                    <h1 class="card-title pricing-card-title"><small class="text-muted fw-light">{{ lapkems.fl_lapkem }}</small></h1>
                    <br/>
                    <a :href="`http://localhost:8000/storage/Lapkemajuans/${lapkems.fl_lapkem}`" class="w-100 btn btn-lg btn-primary">Download File</a>
                </div>
                </div>
            </div>
            ...
            <div class="my-3 p-3 bg-light rounded shadow-sm">
                ...
                <p class="pb-3 mb-0 small lh-sm border-bottom">
                    ...
                    {{ moment(String(lapkems.created_at)).format('dddd-MM-YYYY') }}
                </p>
                </div>
                <small class="d-block text-end mt-3" v-if="lapkems.status == 'Sedang diproses'">
