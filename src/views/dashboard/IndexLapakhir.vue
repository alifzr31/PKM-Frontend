<template>
    <div>
        ...
        <header>
            ...
            <h1 class="display-4 fw-normal">Data Laporan Akhir Anda</h1><br/>
            <p class="fs-5 text-muted">
                <router-link :to="{ name: 'lapakhir.create' }" class="btn btn-lg btn-primary">Input Laporan <i class="bi bi-arrow-right-circle"></i></router-link>
            </p>
            </div>
        </header>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <tr v-for="(lapakhir, index) in lapakhirs" :key="index">
                        ...
                        <td>{{ moment(String(lapakhir.created_at)).format('dddd-MM-YYYY') }}</td>
                        <td>{{ lapakhir.status }}</td>
                        <td><router-link :to="{ name: 'lapakhir.detail', params: {id: lapakhir.id} }" class="btn btn-sm btn-primary">Lihat Data</router-link></td>
                    </tr>
                </tbody>
            </table>
        </main>
