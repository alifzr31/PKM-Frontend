        ...
        <div class="container py-3">
            <header>
                ...
                <div>
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><router-link :to="{ name: 'luaran.detail' }" class="text-decoration-none">{{ jdl.judul }}</router-link></li>
            ...
            <main>
                ...
                <div class="col-md-7 col-lg-12">
                    ...
                    <button class="w-100 btn btn-success btn-lg" type="submit">Edit Luaran</button>
                    </form>
                </div>
                </div>
            </main>
    ...
    setup() {
        ...
        onMounted(() => {
            ...
            .then(response => {
                ...
                luarans.judul = response.data.data.judul
                luarans.publikasi = response.data.data.publikasi
                luarans.fl_luaran = response.data.data.fl_luaran
                luarans.artikel = response.data.data.artikel
                luarans.nip = response.data.data.nip
            }).catch(error => {
                console.log(error.response.data);
            })
        })
        ...
        function update() {
            ...
            axios.post(`http://localhost:8000/api/luarans/${route.params.id}`, formData)
            .then(response => {
                console.log(response.data.data);
                router.push({
                    name: 'luaran.index'
