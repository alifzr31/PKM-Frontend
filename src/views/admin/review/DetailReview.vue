        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Detail Data Review</h1>
                </div>
                
                <div class="col-12">
                    <div class="card mb-4 rounded-3 shadow-sm border-danger">
                    <div class="card-header py-3 text-white bg-danger border-danger">
                        <h5 class="my-0 fw-normal">File Review</h5>
                    </div>
                    <div class="card-body">
                        <h4 class="card-title pricing-card-title"><small class="text-muted fw-light">{{ reviews.fl_proposal }}</small></h4>
                        <a :href="`http://localhost:8000/storage/proposals/${reviews.fl_proposal}`" class="btn btn-md btn-danger"><i class="bi bi-file-pdf"></i> Download File</a>
                    </div>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-sm">
                        ...
                        <tbody>
                            <tr>
                                <td>{{ reviews.judul }}</td>
                                <td>Rp {{ formatdana(reviews.dana) }}</td>
                                <td>{{ reviews.catatan_uppm }}</td>
                                <td>{{ reviews.nip }}</td>
