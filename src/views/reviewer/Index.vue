        ...
        <div class="container py-3">
            <header>
                ...
                <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
                    <h4 class="display-4 fw-normal">Data Review Proposal</h4>
                </div>
            </header>

            <main>
                <div class="table-responsive">
                    <h5>Belum direview</h5>
...
export default {
    setup() {
        ...
        onMounted(() => {
            ...
            axios.get('http://localhost:8000/api/hasilterimadantolak')
            .then(response => {
                console.log(response.data.data);
