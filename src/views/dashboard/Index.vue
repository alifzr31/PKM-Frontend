            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <tr v-for="(prop, index) in proposals" :key="index">
                        <th scope="row">{{ prop.judul }}</th>
                        <td>Rp {{ formatdana(prop.dana) }}</td>
                        <td>{{ prop.fl_proposal }}</td>
                        <td>{{ prop.status }}</td>
                        <td><router-link :to="{ name: 'proposal.detail', params: {id: prop.id} }" class="btn btn-sm btn-primary">Lihat Data</router-link></td>
                    </tr>
                </tbody>
            </table>
        </main>
