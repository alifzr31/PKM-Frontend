            ...
            <header>
                <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
                    ...
                    <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
                        ...
                        <router-link :to="{ name: 'review.index'}" class="me-3 py-2 text-dark text-decoration-none"><b style="color: #0d6efd;">Review</b></router-link>
                    </nav>
                    ...
                    <div class="dropdown text-end">
                        ...
                        <ul class="dropdown-menu text-small" aria-labelledby="dropdownUser1">
                            <li><p style="text-align: center;">{{ user.name }}</p></li>
                            <li><hr class="dropdown-divider"></li>
                ...
                <article class="my-3" id="breadcrumb">
                    <div>
                        <div class="bd-example">
                            ...
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><router-link :to="{ name: 'review.index' }" class="text-decoration-none">Review</router-link></li>
                                <li class="breadcrumb-item active" aria-current="page">{{ reviews.judul }}</li>
                            </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
                    <h1 class="display-4 fw-normal">{{ reviews.judul }}</h1>
                </div>
            </header>
            ...
            <main>
                <div class="col">
                    ...
                    <div class="card-header py-3 text-white bg-primary border-primary">
                        <h4 class="my-0 fw-normal">File Hasil Review</h4>
                    </div>
                    <div class="card-body">
                        <h1 class="card-title pricing-card-title"><small class="text-muted fw-light">{{ reviews.fl_proposal }}</small></h1>
                        <br/>
                        <button type="button" class="w-100 btn btn-lg btn-primary">Download file</button>
                    </div>
                    </div>
                </div>
                ...
                <div class="my-3 p-3 bg-light rounded shadow-sm">
                    ...
                    <p class="pb-3 mb-0 small lh-sm border-bottom">
                        <strong class="d-block text-gray-dark">No. Surat</strong>
                        {{ reviews.no_surat }}
                    </p>
                    </div>
                    <div class="d-flex text-muted pt-3">
