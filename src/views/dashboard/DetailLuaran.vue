        ...
        <div class="container py-3">
            <header>
                ...
                <div>
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><router-link :to="{ name: 'luaran.index' }" class="text-decoration-none">Detail Data Luaran</router-link></li>
                        <li class="breadcrumb-item active" aria-current="page">{{ luarans.judul }}</li>
                    </ol>
                    </nav>
                    </div>
                </div>
                ...
                <h1 class="display-4 fw-normal">{{ luarans.judul }}</h1>
                </div>
            </header>
            ...
            <main>
                <div class="col">
                    ...
                    <div class="card-header py-3 text-white bg-primary border-primary">
                        <h4 class="my-0 fw-normal">File Luaran</h4>
                    </div>
                    <div class="card-body">
                        <h1 class="card-title pricing-card-title"><small class="text-muted fw-light">{{ luarans.fl_luaran }}</small></h1>
                        <br/>
                        <a :href="`http://localhost:8000/storage/luarans/${luarans.fl_luaran}`" class="w-100 btn btn-lg btn-primary">Download File</a>
                    </div>
                    </div>
                </div>
                ...
                <div class="my-3 p-3 bg-light rounded shadow-sm">
                    ...
                    <p class="pb-3 mb-0 small lh-sm border-bottom">
                        <strong class="d-block text-gray-dark">Link Publikasi</strong>
                        <a :href="luarans.publikasi">{{ luarans.publikasi }}</a>
                    </p>
                    </div>
                    <div class="d-flex text-muted pt-3">
                    ...
                    <p class="pb-3 mb-0 small lh-sm border-bottom">
                        <strong class="d-block text-gray-dark">Link Artikel</strong>
                        <a :href="luarans.artikel">{{ luarans.artikel }}</a>
                    </p>
                    </div>
                    <div class="d-flex text-muted pt-3">
                    ...
                    <p class="pb-3 mb-0 small lh-sm border-bottom">
                        ...
                        {{ moment(String(luarans.created_at)).format('dddd-MM-YYYY') }}
                    </p>
                    </div>
                    <small class="d-block text-end mt-3" v-if="luarans.status == 'Sedang diproses'">
                        <router-link :to="{ name: 'luaran.edit' }" class="btn btn-success" style="width: 100%;">Edit Data</router-link>
                    </small>
                    <small class="d-block text-end mt-3" v-else>
                        ...
                        <h4 class="text-center"><i style="color: #198754;">***Luaran sudah diterima***</i></h4>
                    </small>
                </div>
            </main>
...
export default {
    setup() {
        ...
        onMounted(() => {
            ...
            axios.get(`http://localhost:8000/api/luarans/${route.params.id}`)
            .then(response => {
