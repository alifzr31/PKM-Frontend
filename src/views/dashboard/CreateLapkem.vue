            ...
            <header>
                ...
                <div>
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Input Laporan Kemajuan</li>
                    </ol>
                    </nav>
                    </div>
                </div>
                ...
                <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
                    <h1 class="display-4 fw-normal">Input Laporan Kemajuan</h1>
                </div>
            </header>
            ...
            <main>
                ...
                <div class="col-md-7 col-lg-12">
                    ...
                    <div class="row g-3">
                        ...
                        <input type="text" v-model="lapkems.nip" readonly hidden>

                        <div class="col-6">
                            <label for="email" class="form-label">Judul</label>
                            <select v-model="lapkems.judul" class="form-control">
                        ...
                        <div class="col-6">
                            <label for="address2" class="form-label">File Laporan Kemajuan <i><span style="color: red;">*.pdf | Max 10MB</span></i></label>
                            <input type="file" class="form-control" @change="selectLapkem">
                            <div v-if="validation.fl_lapkem" class="mt-2 text-danger">
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control" v-model="lapkems.catatan" placeholder="Catatan" style="height: 200px; resize: none;"></textarea>
...
export default {
    setup() {
        ...
        function store() {
            ...
            axios.post('http://localhost:8000/api/lapkems', formData)
            .then(response => {
