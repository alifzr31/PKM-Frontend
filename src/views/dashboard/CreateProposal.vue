    ...
    <div>
        ...
        <header>
            ...
            <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
                <h1 class="display-4 fw-normal">Pengajuan Proposal</h1>
            </div>
        </header>
        ...
        <main>
            ...
            <div class="col-md-7 col-lg-12">
                ...
                <div class="row g-3">
                    ...
                    <input type="text" v-model="proposals.status" readonly hidden>
                    <input type="text" v-model="proposals.nip" readonly hidden>
                    ...
                    <div class="col-12">
                        <label for="address2" class="form-label">File Proposal <span class="text-muted"></span> <i><span style="color: red;"> *.pdf | Max 10MB</span></i></label>
                    ...
                    <!-- <div class="col-6">
                        <label for="address2" class="form-label">File Proposal External <span class="text-muted"></span> <i><span style="color: red;"> *.pdf | Max 10 Mb</span></i></label>
                ...
                <button class="w-100 btn btn-primary btn-lg" type="submit">Ajukan Proposal</button>
                </form>
            </div>
            </div>
        </main>
...
export default {
    setup() {
        ...
        //     proposals.fl_luaran.push(selectedFile)
