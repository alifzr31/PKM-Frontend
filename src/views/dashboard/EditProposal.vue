    ...
    <div>
        ...
        <header>
            ...
            <div>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><router-link :to="{ name: 'proposal.detail' }" class="text-decoration-none">{{ jdl.judul }}</router-link></li>
            ...
            <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
                <h1 class="display-4 fw-normal" v-if="proposals.status == 'Revisi'">Revisi Pengajuan</h1>
                <h1 class="display-4 fw-normal" v-else-if="proposals.status !== 'Revisi'">Edit Data</h1>
                <p class="lead">{{ jdl.judul }}</p>
            </div>
        </header>
        ...
        <main>
            ...
            <div class="col-md-7 col-lg-12">
                ...
                <form class="needs-validation" v-if="proposals.status == 'Revisi'" @submit.prevent="revisi" enctype="multipart/form-data">
                <div class="row g-3">
                    
                    <div class="col-6">
                        <label for="email" class="form-label">Judul</label>
                        <input type="text" class="form-control" v-model="proposals.judul" placeholder="Judul">
                        <div v-if="validation.judul" class="mt-2 text-danger">
                            {{ validation.judul[0] }}
                        </div>
                    </div>
                    ...
                    <div class="col-6">
                        ...
                        <div v-if="validation.dana" class="mt-2 text-danger">
                            {{ validation.dana[0] }}
                        </div>
                    </div>

                    <div class="col-12">
                        <label for="address2" class="form-label">File Proposal <span class="text-muted">(Optional)</span> <i><span style="color: red;"> *.pdf | Max 10MB</span></i></label>
                    ...
                    <!-- <div class="col-6">
                        <label for="address2" class="form-label">File Proposal External <span class="text-muted">(Optional)</span> <i><span style="color: red;"> *.pdf, .docx, .doc | Max 2048Kb</span></i></label>
                        <input type="file" class="form-control" @change="selectProposalExternal">
                        <div v-if="validation.fl_proposal_external" class="mt-2 text-danger">
                ...
                <button class="w-100 btn btn-success btn-lg" type="submit">Revisi</button>
                </form>

                <form class="needs-validation" v-else-if="proposals.status !== 'Revisi'" @submit.prevent="update" enctype="multipart/form-data">
                <div class="row g-3">
...
export default {
    setup() {
        ...
        function revisi() {
            ...
            formData.append('fl_proposal', proposals.fl_proposal)
            // formData.append('fl_proposal_external', proposals.fl_proposal_external)
            formData.append('status', 'Sudah direvisi')
            formData.append('nip', proposals.nip)
